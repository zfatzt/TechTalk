<div id="chat" class="row">
	...
	<div class="links col">
		...
		<div class="chatBoxKlein">
			<a href="/chat/bitcoin"><h3>Bitcoin</h3></a> 
			<a href="/chat/drone"><h3>Dronen</h3></a>
		</div>
	</div>
	<div id="rechts" class="col">
		<div class="chatBoxGross">Lorem ipsum dolor sit amet, consetetur
			...
			facerLorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
			diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam
			erat, sed diam voluptua. At vero eos et accusam et justo duo dolores
			et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est
			...
			congue nihil imperdiet doming id quod mazim placerat facer</div>
		<div id="nachricht">
			<div class="input-group">
				<input type="text" class="form-control"
					placeholder="Nachricht eingeben..."> <span class="input-group-btn">
					<button id="absendenButton" class="btn btn-success" type="button">
