<div class="slideshow">
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="item">
				<img class="second-slide" src="/images/drone.jpg" alt="Second slide">
				<div class="container">
					<div class="carousel-caption">
						<h1>Dronen Talk</h1>
			...
			<div class="item">
				<img class="third-slide" src="/images/huawei-p10.jpg"
					alt="Third slide">
				<div class="container">
					<div class="carousel-caption">
						<h1>Huawei P10</h1>
						<p>Das neue Huawei P10 ist raus. Was haltest du von dem Smartphone
							?</p>
						<p>
							<a class="btn btn-lg btn-primary" href="#" role="button">Chatten
							</a>
						</p>
					</div>
				</div>
