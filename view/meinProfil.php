		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<input class="form-control" type="text"
					...
					name="accountBearbeitenBenutzername" required="required"
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<input class="form-control"
					...
					onkeyup="accountBearbeitenUeberpruefung()" required="required"
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="submit" class="btn btn-primary"
							...
							<form class="form-horizontal" method="post" action="/user/profilLoeschen">
								<button type="submit" class="btn btn-default" style="color: white; flaot: right; background-color: red">Profil Löschen</button>
